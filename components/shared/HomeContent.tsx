      ...
      <div className="mx-auto sm:text-center lg:max-w-2xl">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            Welcome to InterviewAI, your go-to platform for practicing and improving your interview skills with AI-generated interviews. Hone your skills and boost your confidence for your next big opportunity.
          </p>
        </div>
        ...
        <p className="max-w-xl mb-4 text-base text-gray-700 sm:mx-auto">
          Our platform leverages advanced AI technology to generate realistic interview questions, provide feedback, and help you track your progress over time. Get ready to impress your future employers with InterviewAI.
        </p>
      </div>
